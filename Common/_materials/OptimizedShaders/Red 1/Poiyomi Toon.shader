Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/8ef98f7896441a847b2ba19a1a26069f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = 0.706;
				float smoothness2 = 1.0;
				float metallic = 0.133;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.002555641,0.002555641,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0.002555641,0.002555641,1).a;
				if (2.0)
				{
					#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
